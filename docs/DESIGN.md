...
| ADR-11 | ارائه‌دهندگان داده خارجی (فاز ۲.۷) | همگام‌سازی مستقیم / لایه انتزاعی مرجع (Market Data Provider Layer) | **لایه انتزاعی مرجع فقط‌خواندنی (Reference Only)** | قیمت‌ها و مشاهدات کیف‌پول هرگز روی دفترکل و اسناد مالی اثر نمی‌گذارند و از شمارش مضاعف جلوگیری می‌شود |
