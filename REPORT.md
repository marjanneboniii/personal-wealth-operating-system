...
> **یادداشت به‌روزرسانی 2026-08-23:** توضیحات این گزارش دربارهٔ Symbol فنی املاک، وضعیت تاریخی همان تغییر است و اکنون منسوخ شده است. شناسه جاری املاک و خودرو به دنباله کوتاه مشترک `001` (نمایش فارسی `۰۰۱`) منتقل شده؛ گزارش جدید: [`docs/AUDIT-RWA-SHORT-SYMBOLS-2026-08-23.md`](docs/AUDIT-RWA-SHORT-SYMBOLS-2026-08-23.md).
