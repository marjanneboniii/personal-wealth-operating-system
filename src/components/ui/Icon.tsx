...
const PATHS: Record<string, JSX.Element> = {
  ...
  car: (
    <>
      <path d="M4.5 12.5 6.4 7.9A2 2 0 0 1 8.2 6.5h7.6a2 2 0 0 1 1.8 1.4l1.9 4.6" />
      <rect x="3.5" y="12.5" width="17" height="4.5" rx="1.5" />
      <path d="M6.5 17v2M17.5 17v2" />
    </>
  ),
  food: (
    <>
      <path d="M6 3.5V9a3 3 0 0 0 6 0V3.5" />
      <path d="M9 3.5v17" />
      <path d="M17.5 20.5v-17c-2 1.5-3 4-3 7V13h3" />
    </>
  ),
  heart: <path d="M12 19.5s-7-4.3-8.4-8.8A4.5 4.5 0 0 1 12 7.3a4.5 4.5 0 0 1 8.4 3.4C19 15.2 12 19.5 12 19.5z" />,
  ...
  users: (
    <>
      ...
      <path d="M15.5 5.8a3 3 0 0 1 0 5.4M17.5 14.2a5.5 5.5 0 0 1 3 4.8" />
    </>
  ),
  shield: <path d="M12 3.5 5 6v5.5c0 4.3 3 7.6 7 9 4-1.4 7-4.7 7-9V6z" />,
  book: (
    <>
      <path d="M5 4.5h5.5A1.5 1.5 0 0 1 12 6v14a1.5 1.5 0 0 0-1.5-1.5H5z" />
      <path d="M19 4.5h-5.5A1.5 1.5 0 0 0 12 6v14a1.5 1.5 0 0 1 1.5-1.5H19z" />
    </>
  ),
  briefcase: (
    <>
  ...
  gift: (
    <>
      ...
      <path d="M12 8.5c-1.5-3.5-4.5-3.5-4.5-1.5S10.5 8.5 12 8.5s4.5.5 4.5-1.5-3-2-4.5 1.5" />
    </>
  ),
  // Navigation
  overview: (
  ...
  "eye-off": (
    <>
      <path d="M9.9 5.7A9.6 9.6 0 0 1 12 5.5c6 0 9.5 6.5 9.5 6.5a17 17 0 0 1-2.6 3.4M6.6 6.6C4 8.3 2.5 12 2.5 12S6 18.5 12 18.5a9.4 9.4 0 0 0 5.4-1.6" />
