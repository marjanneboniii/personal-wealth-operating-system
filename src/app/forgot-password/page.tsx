...
export default function ForgotPasswordPage() {
  return <div className="mx-auto max-w-md py-12">
    <div className="card space-y-4 p-6">
      ...
      <p className="muted text-[length:var(--fs-xs)]">لینک امن تغییر رمز به ایمیل شما ارسال می‌شود.</p>
      ...
      <Link className="muted block text-center text-[length:var(--fs-xs)]" href="/login">بازگشت به ورود</Link>
    </div>
  </div>;
}
