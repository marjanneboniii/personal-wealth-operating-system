...
export const metadata: Metadata = {
  title: "شرایط استفاده",
  description: "شرایط استفاده از تراز به‌عنوان سیستم مدیریت ثروت شخصی.",
};
    ...
    <div className="landing">
      ...
      <article className="landing-legal">
        ...
        <p className="sub mt-4 text-[15px] leading-8">
          تراز ابزاری برای ثبت و مشاهده وضعیت مالی شخصی است، نه مشاور سرمایه‌گذاری و نه مؤسسه مالی. شما مسئول صحت
